  ...
  return (
    ...
    >
      <section className="flex flex-col md:flex-row w-screen  md:px-24 px-6 justify-between  ">
        ...
        <div className="max-w-full md:max-w-[40vw] lg:max-w-[30vw] md:max-h-screen max-h-[50vh] overflow-hidden flex justify-center">
      ...
      <section className="flex flex-col items-center lg:p-24 p-12 w-screen">
